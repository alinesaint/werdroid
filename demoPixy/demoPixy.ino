...
{ 
  ...
  if (blocks)
  {
    ...
    if (i%50==0)
    {
      ...
      //label détecté
      sig = pixy.blocks[0].signature;
      //position x de l'objet
      x = pixy.blocks[0].x;
      //position y de l'objet
      y = pixy.blocks[0].y;
      
      //c'est la fete du print
      Serial.print("\n");
      Serial.print("signature label :");
      Serial.print(sig);
      Serial.print("\n");
      Serial.print("x :");
      Serial.print(x);
      ...
      //en connaissant le taille de l'objet déterminer la distance....
      //exemple : position
      //exemple : combien d'objet détecté par label
    }
  }  
}
